        ...
        <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
          <div className="flex flex-col items-start">
            ...
            <p className="mt-6 text-base leading-7 text-white-400 font-montserrat sm:max-w-sm">
              ...
              Cupiditate ipsam nemo deserunt aspernatur? Iure omnis nostrum
              possimus ex nesciunt error itaque cumque dolore, rerum, doloribus
              alias ut? Quos, obcaecati assumenda!
            </p>
